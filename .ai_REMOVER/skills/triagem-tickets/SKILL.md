...
Seguir [CLAUDE.md § 1.3 Git and GitHub](../../CLAUDE.md): **somente leitura** no remoto. **Não** atribuir (`assignee`), comentar, editar labels nem mover o card no board, salvo pedido explícito do usuário.
...
1. MCP GitHub (`Toolbox` (tools `mcp__Toolbox__*`)) — issue, comentários, timeline, PRs ligados
...
O roster é [`.claude/references/roster-agx.md`](../../references/roster-agx.md) — 15 devs entre os 32 membros da org. Não deduzir do nome do autor.
