...
description: >-
  ...
  static HTML extraction, design system extraction, and file upload. Loaded via
  stitch-workflow when migrating or saving existing web apps to Stitch.
allowed-tools:
  - "stitch*:*"
  - "Bash"
  - "Read"
...
Read [extract-static-html/SKILL.md](../extract-static-html/SKILL.md) for detailed instructions and script usage.
...
[extract-design-md/SKILL.md](../extract-design-md/SKILL.md) for the
...
[manage-design-system/SKILL.md](../manage-design-system/SKILL.md) for
...
Read [upload-to-stitch/SKILL.md](../upload-to-stitch/SKILL.md) for detailed instructions and script usage.
