...
name: shadcn-ui
description: >-
  Use when installing, adding, customizing, or troubleshooting shadcn/ui
  components, registry items, or shadcn CLI/MCP setup. Do not use for overall
  visual identity or Stitch workflows.
allowed-tools:
  - "shadcn*:*"
  - "mcp_shadcn*"
  - "Read"
