...
>
> **Quando:** When the user asks for daily, standup, or formatação da daily AGX, follow the skill daily-standup completely — read all three reference files, output every person from the draft, blank line between people, board-ready markdown only.
