...
Sub-skills live in `.claude/skills-lib/stitch/` (not auto-discovered). **Read the matching SKILL.md** before executing.
...
- Requires Stitch MCP (`stitch` (tools `mcp__stitch__*`)) when the sub-skill uses MCP tools.
