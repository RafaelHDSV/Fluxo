---
description: PR review security lock — skill pr-review is read-only; never approve, comment, or publish on GitHub unless explicitly asked to override
alwaysApply: true
emit: [cursor, opencode]
---

# PR review — read-only security lock
