---
description: >-
  Use when writing or reviewing user-facing pt-BR/EN text as Rafael Vieira:
  README, docs/, LinkedIn posts, daily standup, .issues/, emails, narrative
  PR/commit descriptions, or when the user asks for voice/tone/accents.
alwaysApply: false
---
