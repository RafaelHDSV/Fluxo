---
description: >-
  Incremental feature workflow: understand task (current-task.md), consult docs and
  code, write proposal in .issues/, wait for explicit approval before implementing.
  Use for features, broad-scope fixes, or when user cites current-task.md or asks for
  an implementation proposal.
globs: "**/current-task.md,.issues/**/*.md"
alwaysApply: false
---
